...
if (Meteor.isClient) {
  describe('Editor', function () {
    ...
    it('should render note not found message', function () {
      const wrapper = mount(<Editor browserHistory={browserHistory} call={call} selectedNoteId={1}/>);
    ...
    it('should update note body on textarea change', function () {
      const newBody = 'Test case new body';
      const wrapper = mount(<Editor browserHistory={browserHistory} call={call} selectedNoteId={notes[0]._id} note={notes[0]}/>);
    ...
    it('should update new title on input change', function () {
      const newTitle = 'Test case new title';
      const wrapper = mount(<Editor browserHistory={browserHistory} call={call} selectedNoteId={notes[0]._id} note={notes[0]}/>);
